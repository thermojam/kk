...
- **Левая:** `<Logo variant="mark+text" />`, «Психолог · Консультант по рациональному питанию», дисклеймер «Услуги психолога не являются психотерапией и медицинской помощью» — Nunito Regular Small, `text-neutral-500`.
