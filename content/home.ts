...
export const services: Service[] = [
    ...
    },
    {
        ...
        cta: {
            ...
            tgText: 'Здравствуйте! Хочу записаться на программу «Три ступени к телу». Как оплатить?',
        },
        featured: true,
    },
    {
    ...
    {
        id: 'nutrition-psychosomatics-combo',
        badge: 'Комбо',
        title: 'Питание и образ жизни + психосоматика',
        subtitle: 'Интегральный онлайн-подход',
        description:
...
export const qualifications: Qualification[] = [
    ...
    {
        title: 'Психолог-консультант, «Психосоматика и телесная терапия»',
        institution: 'Практический институт клинической психологии и психосоматики',
    },
